    ...
    <div>
        ...
        <el-form :model="tenant" ref="tenantForm" :rules="formRules" label-position="left" label-width="100px"
            ...
            <el-form-item prop="companyName" label="机构名称">
                <el-input type="text" v-model="tenant.companyName" auto-complete="off"
            ...
            <el-form-item prop="address" label="机构地址">
                <el-input type="text" style="width: 350px" v-model="tenant.address" auto-complete="off"
                          placeholder="请输入地址！">
                </el-input>
            ...
            <el-form-item prop="adminUser.comfirmPassword" label="确认密码">
                <el-input type="password" v-model="tenant.comfirmPassword" auto-complete="off"
